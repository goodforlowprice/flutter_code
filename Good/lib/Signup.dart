    ...
    body: SingleChildScrollView
      ...
      child: Column(
        children: [
          ...
          Center(
            child: Text("SIGN UP",style: CustomColors.sliderscreen_title_style),
          ),
          SizedBox(height: 20),
          Row(
            children: [
          ...
          Padding(
            ...
            child: Container(
              ...
              child: MaterialButton(
                ...
                child: Text("SIGN UP",style:CustomColors.sliderscreen_button_style),
              ),
            ),
          ),
          SizedBox(height: 30),
          ...
          Row(
            ...
            Padding(
              ...
              child: Text(" Sign in",style:CustomColors.already_account_login_text),
            ),
